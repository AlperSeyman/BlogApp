...
async def get_Allpost_api(db: Annotated[AsyncSession, Depends(get_db)]):
...
async def updateFull_post_api(post_id: int, post_data: PostCreate, db: Annotated[AsyncSession, Depends(get_db)]):
...
async def updatePartial_post_api(post_id: int, post_data: PostUpdate, db: Annotated[AsyncSession, Depends(get_db)]):
...
async def create_post_api(post: PostCreate, db: Annotated[AsyncSession, Depends(get_db)]):
...
async def delete_post_api(post_id: int, db: Annotated[AsyncSession, Depends(get_db)]):
...
async def get_all_users_api(db: Annotated[AsyncSession, Depends(get_db)]):
...
async def get_user_by_id_api(user_id: int, db: Annotated[AsyncSession, Depends(get_db)]):
...
async def updateAll_user_api(user_id: int, user_data: UserUpdate, db: Annotated[AsyncSession, Depends(get_db)]):
...
async def create_user_api(user: UserCreate, db: Annotated[AsyncSession, Depends(get_db)]):
